...
public class PassagemServlet extends HttpServlet {
	...
	protected void create(HttpServletRequest request, HttpServletResponse response)
	    ...
	    String valor_passagem = request.getParameter("valor_passagem");

	    try {
	        double valor = Double.parseDouble(valor_passagem);

	        Passagens passagem = new Passagens(valor, cliente, destino);

	        pdao.create(passagem);

	        response.sendRedirect("passagem");
	    } catch (NumberFormatException e) {
	        response.getWriter().println("O valor da passagem deve ser um número válido.");
	    }
	}
	...
	protected void update(HttpServletRequest request, HttpServletResponse response)
	    ...
	    int id = Integer.parseInt(request.getParameter("id"));
	    Clientes cliente = cdao.readById(Integer.parseInt(request.getParameter("cliente")));
	    Destinos destino = ddao.readById(Integer.parseInt(request.getParameter("passagem")));
