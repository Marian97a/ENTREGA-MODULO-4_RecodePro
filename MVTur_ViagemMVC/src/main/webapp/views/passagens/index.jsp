				...
				<table class="table table-responsive table-hover">
					<thead class="table-primary">
						<tr>
							...
							<th scope="col">valor_passagem</th>
					...
					<tbody>
							...
							<tr>
							    ...
							    <td>${p.cliente.destino}</td>
							    <td>${p.destino.partida}</td>
							    <td>${p.destino.destino}</td>
								<td>${p.valor_passagem}</td>
								<td>
									<div class="d-flex">
										...
										<a href="passagem-delete?id=${p.id}" class="mx-1" title="Cancelar"
											onclick="return confirm('Deseja excluir o passagem.')">
